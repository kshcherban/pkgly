...
impl RepositoryType for MavenRepositoryType {
    ...
    fn get_description(&self) -> super::RepositoryTypeDescription {
        super::RepositoryTypeDescription {
            ...
            documentation_url: Some("https://pkgly.kingtux.dev/repositoryTypes/maven/"),
            is_stable: true,
