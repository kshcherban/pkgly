...
if this path resolves it should return a web login response. However, this feature is not documented here or implemented in Pkgly so this returns a bad request.
